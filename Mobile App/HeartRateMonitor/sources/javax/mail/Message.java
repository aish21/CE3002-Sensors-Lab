...
public abstract class Message implements Part {
    ...
    public static class RecipientType implements Serializable {
        ...
        /* renamed from: CC */
        public static final RecipientType f297CC = new RecipientType("Cc");

        /* renamed from: TO */
        public static final RecipientType f298TO = new RecipientType("To");
    ...
    public Address[] getAllRecipients() throws MessagingException {
        ...
        int i2;
        int i3;
        Address[] to = getRecipients(RecipientType.f298TO);
        Address[] cc = getRecipients(RecipientType.f297CC);
    ...
    public void setRecipient(RecipientType type, Address address) throws MessagingException {
        if (address == null) {
            setRecipients(type, (Address[]) null);
            return;
        }

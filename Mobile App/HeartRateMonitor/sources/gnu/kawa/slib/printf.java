...
public class printf extends ModuleBody {
    ...
    public static Object stdio$ClParseFloat(Object str, Object proc) {
        ...
        try {
            frame14.f99n = strings.stringLength((CharSequence) obj);
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda2sign(Object i, Object cont) {
            if (Scheme.numLss.apply2(i, Integer.valueOf(this.f99n)) == Boolean.FALSE) {
                return Values.empty;
            }
            Object obj = this.str;
            try {
        ...
        public Object lambda3digits(Object i, Object cont) {
            ...
            Object j = i;
            while (true) {
                Object apply2 = Scheme.numGEq.apply2(j, Integer.valueOf(this.f99n));
                try {
        ...
        public Object lambda5(Object i, Object sgn, Object digs, Object ex) {
            ...
            frame0.digs = digs;
            frame0.f100ex = ex;
            if (Scheme.numEqu.apply2(i, Integer.valueOf(this.f99n)) != Boolean.FALSE) {
                return Scheme.applyToArgs.apply4(this.proc, frame0.sgn, frame0.digs, frame0.f100ex);
            }
            Object obj = this.str;
            try {
                try {
                    if (C0654lists.memv(Char.make(strings.stringRef((CharSequence) obj, ((Number) i).intValue())), printf.Lit2) != Boolean.FALSE) {
    ...
    public class frame4 extends ModuleBody {
        ...
        public Object lambda13(Object i, Object fdigs) {
            ...
            if (Scheme.numGEq.apply2(i, Integer.valueOf(this.staticLink.staticLink.staticLink.f99n)) != Boolean.FALSE) {
                return Scheme.applyToArgs.apply3(frame6.cont, i, printf.Lit1);
            }
            Object obj = this.staticLink.staticLink.staticLink.str;
            try {
                try {
                    if (C0654lists.memv(Char.make(strings.stringRef((CharSequence) obj, ((Number) i).intValue())), printf.Lit10) != Boolean.FALSE) {
    ...
    public class frame1 extends ModuleBody {
        ...
        public Object lambda8(Object im$Mnsgn, Object im$Mndigs, Object im$Mnex) {
            return Scheme.applyToArgs.applyN(new Object[]{this.staticLink.staticLink.proc, this.sgn, this.digs, this.f101ex, im$Mnsgn, im$Mndigs, im$Mnex});
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:150:0x0335, code lost:
        r1 = kawa.lib.C0654lists.cdr.apply1(r12.args);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:239:0x04fb, code lost:
        if (kawa.standard.Scheme.numGrt.apply2(r12.width, gnu.kawa.functions.AddOp.$Mn.apply2(r12.precision, r12.f103pr)) == java.lang.Boolean.FALSE) goto L_0x03d8;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:240:0x04fd, code lost:
        r11 = kawa.standard.Scheme.applyToArgs;
        r13 = r2.out;
        r10 = gnu.kawa.functions.AddOp.$Mn.apply2(r12.width, gnu.kawa.functions.AddOp.$Mn.apply2(r12.precision, r12.f103pr));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:256:0x054d, code lost:
        kawa.standard.Scheme.applyToArgs.apply2(r2.out, r12.f102os);
     */
    ...
    public static java.lang.Object stdio$ClIprintf$V(java.lang.Object r17, java.lang.Object r18, java.lang.Object[] r19) {
        ...
        L_0x0092:
            ...
            java.lang.Object r11 = r2.f106fc
            java.lang.Object r9 = r9.apply2(r10, r11)
            java.lang.Boolean r10 = java.lang.Boolean.FALSE
            if (r9 == r10) goto L_0x013e
            r2.lambda18mustAdvance()
            java.lang.Object r6 = r2.f106fc
            gnu.kawa.functions.IsEqv r9 = kawa.standard.Scheme.isEqv
        ...
        L_0x022b:
            ...
            boolean r9 = kawa.lib.C0654lists.isNull(r9)
            if (r9 == 0) goto L_0x0264
            java.lang.Object r9 = r2.f106fc
            ...
            java.lang.Object r9 = kawa.lib.C0654lists.memv(r9, r10)
            java.lang.Boolean r10 = java.lang.Boolean.FALSE
            ...
            int r13 = kawa.lib.C0654lists.length(r13)
        ...
        L_0x037c:
            ...
            java.lang.Object r10 = r12.f103pr
        ...
        L_0x03ab:
            gnu.kawa.functions.NumberCompare r9 = kawa.standard.Scheme.numGrt
            java.lang.Object r10 = r12.width
            java.lang.Object r11 = r12.f103pr
            java.lang.Object r9 = r9.apply2(r10, r11)
            java.lang.Boolean r10 = java.lang.Boolean.FALSE
            ...
            gnu.kawa.functions.AddOp r9 = gnu.kawa.functions.AddOp.$Mn
            java.lang.Object r10 = r12.width
            java.lang.Object r14 = r12.f103pr
        ...
        L_0x04e1:
            ...
            java.lang.Object r0 = r12.f103pr
            r16 = r0
            ...
            goto L_0x03d8
        L_0x0528:
            java.lang.Object r9 = r12.f102os
        ...
        L_0x052f:
            ...
            gnu.kawa.functions.ApplyToArgs r9 = kawa.standard.Scheme.applyToArgs
            java.lang.Object r10 = r2.out
            java.lang.Object r11 = r12.f102os
            r9.apply2(r10, r11)
            goto L_0x03d8
        L_0x0558:
            r9 = 0
        ...
        L_0x07d1:
            ...
            java.lang.Object r9 = r10.f104fc
    ...
    public class frame9 extends ModuleBody {
        ...
        public Object lambda18mustAdvance() {
            ...
            if (Scheme.numGEq.apply2(this.pos, Integer.valueOf(this.f107fl)) != Boolean.FALSE) {
            ...
            try {
                ...
                try {
                    this.f106fc = Char.make(strings.stringRef(charSequence, ((Number) obj2).intValue()));
                    return Values.empty;
                } catch (ClassCastException e) {
        ...
        public boolean lambda19isEndOfFormat() {
            return ((Boolean) Scheme.numGEq.apply2(this.pos, Integer.valueOf(this.f107fl))).booleanValue();
        }
        ...
        public Object lambda21out$St(Object strs) {
            ...
            while (true) {
                boolean x = C0654lists.isNull(strs);
                if (x) {
                    return x ? Boolean.TRUE : Boolean.FALSE;
                }
                Object x2 = Scheme.applyToArgs.apply2(this.out, C0654lists.car.apply1(strs));
                if (x2 == Boolean.FALSE) {
                    return x2;
                }
                strs = C0654lists.cdr.apply1(strs);
            }
        }
    }
    ...
    public class frame10 extends ModuleBody {
        ...
        public Object lambda22readFormatNumber() {
            Object[] objArr;
            if (Scheme.isEqv.apply2(printf.Lit66, this.staticLink.f106fc) != Boolean.FALSE) {
                this.staticLink.lambda18mustAdvance();
                Object ans = C0654lists.car.apply1(this.args);
                this.args = C0654lists.cdr.apply1(this.args);
                return ans;
            }
            Object c = this.staticLink.f106fc;
            Object ans2 = printf.Lit1;
            while (true) {
                Object obj = this.staticLink.f106fc;
                try {
                    if (!unicode.isCharNumeric((Char) obj)) {
                        return ans2;
                    }
                    this.staticLink.lambda18mustAdvance();
                    Object c2 = this.staticLink.f106fc;
                    AddOp addOp = AddOp.$Pl;
        ...
        public Object lambda23pad$V(Object pre, Object[] argsArray) {
            ...
            try {
                ...
                while (Scheme.numGEq.apply2(valueOf, this.width) == Boolean.FALSE) {
                    if (!C0654lists.isNull(obj)) {
                        AddOp addOp = AddOp.$Pl;
                        Object apply1 = C0654lists.car.apply1(obj);
                        try {
                            valueOf = addOp.apply2(valueOf, Integer.valueOf(strings.stringLength((CharSequence) apply1)));
                            obj = C0654lists.cdr.apply1(obj);
                        } catch (ClassCastException e) {
                        ...
                        try {
                            ...
                            return C0654lists.cons(pre, append.append$V(objArr));
                        } catch (ClassCastException e2) {
                        ...
                        try {
                            return C0654lists.cons(pre, C0654lists.cons(strings.makeString(((Number) apply22).intValue(), printf.Lit9), strs));
                        } catch (ClassCastException e3) {
                        ...
                        try {
                            return C0654lists.cons(strings.makeString(((Number) apply23).intValue(), printf.Lit29), C0654lists.cons(pre, strs));
                        } catch (ClassCastException e4) {
                            throw new WrongType(e4, "make-string", 1, apply23);
                        }
                    }
                }
                return C0654lists.cons(pre, strs);
            } catch (ClassCastException e5) {
            ...
            try {
                ...
                if (misc.isSymbol(obj)) {
                    ...
                    try {
                        ...
                        s2 = (!x2 ? C0654lists.isNull(obj) : x2) ? "0" : strings.isString(obj) ? obj : "1";
                    } catch (ClassCastException e5) {
        ...
        public Object lambda25(Object s) {
            try {
                this.f103pr = AddOp.$Pl.apply2(this.f103pr, Integer.valueOf(strings.stringLength((CharSequence) s)));
        ...
        public boolean lambda26(Object s) {
            ...
            try {
                Object sl = AddOp.$Mn.apply2(this.f103pr, Integer.valueOf(strings.stringLength((CharSequence) s)));
                try {
        ...
        public Boolean lambda27(Object s) {
            try {
                this.f103pr = AddOp.$Mn.apply2(this.f103pr, Integer.valueOf(strings.stringLength((CharSequence) s)));
                if (this.f102os == Boolean.FALSE) {
                    Scheme.applyToArgs.apply2(this.staticLink.out, s);
                } else {
                    Object obj = this.f103pr;
                    try {
                        if (numbers.isNegative(LangObjType.coerceRealNum(obj))) {
                            Scheme.applyToArgs.apply2(this.staticLink.out, this.f102os);
                            this.f102os = Boolean.FALSE;
                            Scheme.applyToArgs.apply2(this.staticLink.out, s);
                        } else {
                            this.f102os = strings.stringAppend(this.f102os, s);
                        }
                    } catch (ClassCastException e) {
                                    ...
                                    try {
                                        try {
                                            try {
                                                ...
                                                return C0654lists.cons(idigs, (!x2 ? x2 : this.staticLink.alternate$Mnform == Boolean.FALSE) ? LList.Empty : LList.list2(".", fdigs));
                                            } catch (ClassCastException e2) {
        ...
        public Object lambda30formatReal$V(Object signed$Qu, Object sgn, Object digs, Object exp, Object[] argsArray) {
            ...
            if (C0654lists.isNull(rest)) {
                try {
                    ...
                    Object x = Scheme.isEqv.apply2(this.f104fc, printf.Lit13);
                    if (x == Boolean.FALSE ? Scheme.isEqv.apply2(this.f104fc, printf.Lit54) != Boolean.FALSE : x != Boolean.FALSE) {
                        obj3 = Boolean.FALSE;
                    } else {
                        Object x2 = Scheme.isEqv.apply2(this.f104fc, printf.Lit25);
                        if (x2 == Boolean.FALSE ? Scheme.isEqv.apply2(this.f104fc, printf.Lit26) != Boolean.FALSE : x2 != Boolean.FALSE) {
                            obj = lambda29f(digs, exp, Boolean.FALSE);
                            return C0654lists.cons(str, obj);
                        }
                        Object x3 = Scheme.isEqv.apply2(this.f104fc, printf.Lit55);
                        if (x3 == Boolean.FALSE ? Scheme.isEqv.apply2(this.f104fc, printf.Lit56) == Boolean.FALSE : x3 == Boolean.FALSE) {
                            if (Scheme.isEqv.apply2(this.f104fc, printf.Lit57) != Boolean.FALSE) {
                                obj2 = "";
                            } else if (Scheme.isEqv.apply2(this.f104fc, printf.Lit58) != Boolean.FALSE) {
                                obj2 = " ";
                            } else {
                                obj = Values.empty;
                                return C0654lists.cons(str, obj);
    ...
    public static Object sprintf$V(Object str, Object format, Object[] argsArray) {
        ...
        frame132.f105s = error$V;
        Object obj2 = frame132.f105s;
        try {
            ...
            if (Scheme.isEqv.apply2(frame132.end, frame132.cnt) != Boolean.FALSE) {
                return frame132.f105s;
            }
            Object obj3 = frame132.f105s;
            try {

...
public class CompileArith implements Inlineable {
    ...
    public static CompileArith forDiv(Object proc2) {
        return new CompileArith(proc2, ((DivideOp) proc2).f48op);
    }

    public static CompileArith forBitwise(Object proc2) {
        return new CompileArith(proc2, ((BitwiseOp) proc2).f48op);
    }
    ...
    public void compile(ApplyExp exp, Compilation comp, Target target) {
        ...
        if (len == 0) {
            ...
            int kind1 = Arithmetic.classifyType(args[0].getType());
            int kind2 = Arithmetic.classifyType(args[1].getType());
            int kind = getReturnKind(kind1, kind2, this.f49op);
            ...
            if (this.f49op >= 4 && this.f49op <= 8) {
                DivideOp dproc = (DivideOp) this.proc;
                if (dproc.f48op != 4 || (kind > 4 && kind < 6 && kind > 9)) {
                    if ((dproc.f48op == 5 && kind <= 10 && kind != 7) || (dproc.f48op == 4 && kind == 10)) {
                        kind = 8;
                    } else if (((dproc.f48op != 7 && (dproc.f48op != 6 || kind > 4)) || !(dproc.getRoundingMode() == 3 || kind == 4 || kind == 7 || kind == 8)) && !(dproc.f48op == 8 && (dproc.getRoundingMode() == 3 || kind == 4))) {
                        ApplyExp.compile(exp, comp, target);
                        return;
                    }
                }
            }
            if (this.f49op == 4 && kind <= 10 && kind != 8 && kind != 7) {
                if (kind == 6 || kind > 4) {
            ...
            } else if (kind == 4 && (this.f49op == 1 || this.f49op == 3 || this.f49op == 2 || this.f49op == 13 || this.f49op == 14 || this.f49op == 15 || this.f49op == 7 || this.f49op == 8 || (this.f49op >= 9 && this.f49op <= 11))) {
                compileIntNum(args[0], args[1], kind1, kind2, comp);
            } else if (kind == 1 || kind == 2 || ((kind == 7 || kind == 8) && (this.f49op <= 8 || this.f49op >= 13))) {
                Target wtarget2 = StackTarget.getInstance(wtype2);
                CodeAttr code = comp.getCode();
                for (int i = 0; i < len; i++) {
                    if (i == 1 && this.f49op >= 9 && this.f49op <= 12) {
    ...
    public Type getReturnType(Expression[] args) {
        return Arithmetic.kindType(adjustReturnKind(getReturnKind(args), this.f49op));
    }
    ...
    public static Expression validateApplyNumberPredicate(ApplyExp exp, InlineCalls visitor, Type required, Procedure proc2) {
        int i = ((NumberPredicate) proc2).f53op;
        Expression[] args = exp.getArgs();

...
public class XIntegerType extends XDataType {
    ...
    public static final XIntegerType unsignedIntType = new XIntegerType("unsignedInt", (XDataType) unsignedLongType, 14, IntNum.zero(), IntNum.make((long) UIDFolder.MAXUID));

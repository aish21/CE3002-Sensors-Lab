...
public abstract class Complex extends Quantity {
    ...
    public boolean isExact() {
        return mo11197re().isExact() && mo11196im().isExact();
    }

    /* Debug info: failed to restart local var, previous not found, register: 4 */
    public Complex toExact() {
        RealNum re = mo11197re();
        RealNum im = mo11196im();
    ...
    public Complex toInexact() {
        return isExact() ? this : new DComplex(mo11197re().doubleValue(), mo11196im().doubleValue());
    }
    ...
    public double doubleValue() {
        return mo11197re().doubleValue();
    }

    public double doubleImagValue() {
        return mo11196im().doubleValue();
    }
    ...
    public static boolean equals(Complex x, Complex y) {
        return x.mo11197re().equals(y.mo11197re()) && x.mo11196im().equals(x.mo11196im());
    }
    ...
    public static int compare(Complex x, Complex y) {
        int code = x.mo11196im().compare(y.mo11196im());
        return code != 0 ? code : x.mo11197re().compare(y.mo11197re());
    }
    ...
    public boolean isZero() {
        return mo11197re().isZero() && mo11196im().isZero();
    }

    public String toString(int radix) {
        if (mo11196im().isZero()) {
            return mo11197re().toString(radix);
        }
        String imString = mo11196im().toString(radix) + "i";
        if (imString.charAt(0) != '-') {
            imString = "+" + imString;
        }
        return !mo11197re().isZero() ? mo11197re().toString(radix) + imString : imString;
    }

    public static Complex neg(Complex x) {
        return make(x.mo11197re().rneg(), x.mo11196im().rneg());
    }
    ...
    public static Complex add(Complex x, Complex y, int k) {
        return make(RealNum.add(x.mo11197re(), y.mo11197re(), k), RealNum.add(x.mo11196im(), y.mo11196im(), k));
    }
    ...
    public static Complex times(Complex x, Complex y) {
        RealNum x_re = x.mo11197re();
        RealNum x_im = x.mo11196im();
        RealNum y_re = y.mo11197re();
        RealNum y_im = y.mo11196im();

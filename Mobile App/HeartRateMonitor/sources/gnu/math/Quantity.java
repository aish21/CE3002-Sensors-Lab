...
public abstract class Quantity extends Numeric {
    ...
    /* renamed from: re */
    public RealNum mo11197re() {
        return number().mo11197re();
    }

    /* renamed from: im */
    public RealNum mo11196im() {
        return number().mo11196im();
    }
    ...
    public double doubleValue() {
        return unit().doubleValue() * mo11197re().doubleValue();
    }

    public double doubleImagValue() {
        return unit().doubleValue() * mo11196im().doubleValue();
    }

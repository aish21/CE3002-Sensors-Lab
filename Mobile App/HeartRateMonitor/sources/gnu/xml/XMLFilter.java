...
public class XMLFilter implements DocumentHandler, ContentHandler, SourceLocator, XConsumer, PositionConsumer {
    ...
    public int getLineNumber() {
        int line;
        if (this.f236in != null && (line = this.f236in.getLineNumber()) >= 0) {
            return line + 1;
        }
        return -1;
    }
    ...
    public int getColumnNumber() {
        int col;
        if (this.f236in == null || (col = this.f236in.getColumnNumber()) <= 0) {
            return -1;
        }
        return col;
    }

...
class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes((AttributeSet) null, C0002R.styleable.AlertDialog, C0002R.attr.alertDialogStyle, 0);
    ...
    private void setupView() {
        ...
        if (!(hasButtonPanel || contentPanel == null || (spacer2 = contentPanel.findViewById(C0002R.C0004id.textSpacerNoButtons)) == null)) {
        ...
        } else if (!(contentPanel == null || (spacer = contentPanel.findViewById(C0002R.C0004id.textSpacerNoTitle)) == null)) {

...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes((AttributeSet) null, C0002R.styleable.ActionBar, C0002R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0002R.styleable.ActionBar_hideOnContentScroll, $assertionsDisabled)) {

    ...
    private ViewGroup createSubDecor() {
        ...
        if (this.mWindowNoTitle) {
            if (this.mOverlayActionMode) {
                subDecor = (ViewGroup) inflater.inflate(C0002R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null);
            } else {
                subDecor = (ViewGroup) inflater.inflate(C0002R.layout.abc_screen_simple, (ViewGroup) null);
            }
            if (Build.VERSION.SDK_INT >= 21) {
            ...
            subDecor = (ViewGroup) inflater.inflate(C0002R.layout.abc_dialog_title_material, (ViewGroup) null);
            ...
            subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0002R.layout.abc_screen_toolbar, (ViewGroup) null);
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, (AttributeSet) null, C0002R.attr.actionModePopupWindowStyle);
        ...
        if (!st.isOpen && !this.mIsDestroyed) {
            ...
            if (cb == null || cb.onMenuOpened(st.featureId, st.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    st.isHandled = false;
                    WindowManager.LayoutParams lp3 = new WindowManager.LayoutParams(width, -2, st.f5x, st.f6y, 1002, 8519680, -3);

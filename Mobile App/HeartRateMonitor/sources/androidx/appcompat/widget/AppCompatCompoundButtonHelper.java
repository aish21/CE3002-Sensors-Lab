...
class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            if (a.hasValue(C0002R.styleable.CompoundButton_android_button) && (resourceId = a.getResourceId(C0002R.styleable.CompoundButton_android_button, 0)) != 0) {
            ...
            if (a.hasValue(C0002R.styleable.CompoundButton_buttonTintMode)) {
                CompoundButtonCompat.setButtonTintMode(this.mView, DrawableUtils.parseTintMode(a.getInt(C0002R.styleable.CompoundButton_buttonTintMode, -1), (PorterDuff.Mode) null));
            }
        } finally {
            a.recycle();
        }

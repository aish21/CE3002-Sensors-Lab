...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mLayoutParams.windowAnimations = C0002R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, WindowManager.LayoutParams outParams) {
        ...
        if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
            int offsetExtra = this.mContext.getResources().getDimensionPixelOffset(C0002R.dimen.tooltip_precise_anchor_extra_offset);

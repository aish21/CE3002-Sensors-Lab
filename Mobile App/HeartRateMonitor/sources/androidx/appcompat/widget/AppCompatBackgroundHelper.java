    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            if (a.hasValue(C0002R.styleable.ViewBackgroundHelper_backgroundTintMode)) {
                ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(a.getInt(C0002R.styleable.ViewBackgroundHelper_backgroundTintMode, -1), (PorterDuff.Mode) null));
            }
        } finally {
            a.recycle();
        }

    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attrs) {
            ...
            if (a.hasValue(C0002R.styleable.MenuItem_android_checkable)) {
                if (a.getBoolean(C0002R.styleable.MenuItem_android_checkable, defaultItemChecked)) {
                    i = 1;
                } else {
                    i = 0;
                }
            ...
            this.itemChecked = a.getBoolean(C0002R.styleable.MenuItem_android_checked, defaultItemChecked);

...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes((AttributeSet) null, C0002R.styleable.DrawerArrowToggle, C0002R.attr.drawerArrowStyle, C0002R.style.Base_Widget_AppCompat_DrawerArrowToggle);
    ...
    public void setProgress(@FloatRange(from = 0.0d, mo24to = 1.0d) float progress) {

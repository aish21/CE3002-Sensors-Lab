...
public class ConstraintWidget {
    ...
    /* renamed from: mX */
    protected int f255mX;

    /* renamed from: mY */
    protected int f256mY;
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + " " : "") + (this.mDebugName != null ? "id: " + this.mDebugName + " " : "") + "(" + this.f255mX + ", " + this.f256mY + ") - (" + this.mWidth + " x " + this.mHeight + ") wrap: (" + this.mWrapWidth + " x " + this.mWrapHeight + ")";
    }
    ...
    public int getRootX() {
        return this.f255mX + this.mOffsetX;
    }

    /* access modifiers changed from: protected */
    public int getRootY() {
        return this.f256mY + this.mOffsetY;
    }
    ...
    public void updateDrawPosition() {
        int left = this.f255mX;
        int top = this.f256mY;
        int right = this.f255mX + this.mWidth;
        int bottom = this.f256mY + this.mHeight;
        this.mDrawX = left;
        this.mDrawY = top;
    ...
    public void setDrawOrigin(int x, int y) {
        ...
        this.f255mX = this.mDrawX;
        this.f256mY = this.mDrawY;
    }

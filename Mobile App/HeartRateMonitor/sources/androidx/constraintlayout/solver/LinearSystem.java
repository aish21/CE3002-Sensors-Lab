...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object anchor) {
        ...
        if (variable.f253id != -1 && variable.f253id <= this.mVariablesID && this.mCache.mIndexedVariables[variable.f253id] != null) {
            return variable;
        }
        if (variable.f253id != -1) {
            variable.reset();
        }
        this.mVariablesID++;
        this.mNumColumns++;
        variable.f253id = this.mVariablesID;

...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int timeoutMs = array.getInteger(C0105R.styleable.FontFamily_fontProviderFetchTimeout, DEFAULT_TIMEOUT_MILLIS);
        array.recycle();
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int weight = array.getInt(array.hasValue(C0105R.styleable.FontFamilyFont_fontWeight) ? C0105R.styleable.FontFamilyFont_fontWeight : C0105R.styleable.FontFamilyFont_android_fontWeight, NORMAL_WEIGHT);

...
public class File extends AndroidNonvisibleComponent implements Component {
    ...
    @SimpleProperty
    public void Scope(FileScope scope2) {
        this.scope = scope2;
    }
    ...
    @SimpleFunction
    public void MakeDirectory(FileScope scope2, String directoryName, Continuation<Boolean> continuation) {
        if (scope2 == FileScope.Asset) {
        ...
        new SingleFileOperation(this.form, this, "MakeDirectory", directoryName, scope2, FileAccessMode.WRITE, false) {
    ...
    @SimpleFunction
    public void RemoveDirectory(FileScope scope2, String directoryName, final boolean recursive, Continuation<Boolean> continuation) {
        if (scope2 == FileScope.Asset) {
        ...
        new FileOperation.Builder(this.form, this, "RemoveDirectory").addFile(scope2, directoryName, FileAccessMode.WRITE).addCommand(new FileOperation.FileInvocation() {
    ...
    @SimpleFunction
    public void ListDirectory(FileScope scope2, String directoryName, Continuation<List<String>> continuation) {
        if (scope2 != FileScope.Asset || this.form.isRepl()) {
            if (!directoryName.contains("/")) {
                directoryName = directoryName + "/";
            }
            final Synchronizer<List<String>> result = new Synchronizer<>();
            new FileOperation.Builder(this.form, this, "ListDirectory").setAskPermission(true).setAsynchronous(true).addFile(scope2, directoryName, FileAccessMode.READ).addCommand(new FileOperation.FileInvocation() {
        ...
        try {
            continuation.call(FileUtil.listDirectory(this.form, new ScopedFile(scope2, directoryName)));
        } catch (IOException e) {
    ...
    @SimpleFunction
    public void IsDirectory(FileScope scope2, String path, Continuation<Boolean> continuation) {
        if (scope2 != FileScope.Asset || this.form.isRepl()) {
            final Synchronizer<Boolean> result = new Synchronizer<>();
            new FileOperation.Builder(this.form, this, "IsDirectory").addFile(scope2, path, FileAccessMode.READ).addCommand(new FileOperation.FileInvocation() {
                public void call(ScopedFile[] files) {
    ...
    @SimpleFunction
    public void Exists(FileScope scope2, String path, Continuation<Boolean> continuation) {
        final Synchronizer<Boolean> result = new Synchronizer<>();
        new FileOperation.Builder(this.form, this, "Exists").addFile(scope2, path, FileAccessMode.READ).addCommand(new FileOperation.FileInvocation() {
            public void call(ScopedFile[] files) {
    ...
    @SimpleFunction
    public String MakeFullPath(FileScope scope2, String path) {
        return FileUtil.resolveFileName(this.form, path, scope2);
    }

...
public abstract class Sprite extends VisibleComponent implements AlarmHandler, OnDestroyListener, Deleteable {
    ...
    @SimpleProperty
    /* renamed from: Y */
    public void mo7488Y(double y) {
        updateY(y);
        registerChange();
    }

    /* renamed from: Y */
    public double mo5821Y() {
    ...
    @SimpleProperty
    /* renamed from: Z */
    public void mo7490Z(double layer) {
        this.zLayer = layer;

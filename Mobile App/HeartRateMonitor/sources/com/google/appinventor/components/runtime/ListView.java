        ...
        this.txtSearchBox.addTextChangedListener(new TextWatcher() {
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                if (cs.length() == 0) {
                    ...
                    ListView.this.listAdapterWithRecyclerView.getFilter().filter(cs.toString());
                }
            }
    ...
    public void setAdapterData() {
        if (!this.dictItems.isEmpty()) {
            ...
            if (this.orientation == 1) {
                this.recyclerView.setLayoutManager(new LinearLayoutManager(this.container.$context(), 0, DEFAULT_ENABLED));
            } else {
                this.recyclerView.setLayoutManager(new LinearLayoutManager(this.container.$context(), 1, DEFAULT_ENABLED));
            }

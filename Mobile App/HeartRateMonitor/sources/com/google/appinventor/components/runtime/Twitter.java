                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status status : C05076.this.replies) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (User user : C05097.this.friends) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (DirectMessage message : C05118.this.messages) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status message : C049712.this.messages) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status tweet : C049913.this.tweets) {

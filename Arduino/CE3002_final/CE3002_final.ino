...
void setup() {
  ...
  lcd.init();
  lcd.backlight();
  Serial.begin(1200); //for finger thing
...
void welcomeMsg(){
  ...
  lcd.print("PLEASE PLACE"); // Print the string "Hello World!"
...
void heartbeatSound(){
  ...
  do{
    i++;
    tone(buzzer, 1000); //pin 11, 450hz square frequency
    delay(200); //500 millis
    noTone(buzzer); //'free pin 11'
    delay(200); //500 millis
  }
  while(i<2);
